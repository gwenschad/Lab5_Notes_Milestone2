...
public class DBHelper {
    ...
    public void updateNote(String title, String date, String content, String username) {
        createTable();
        //Log.i("update content", content);
        //String updateNote = "UPDATE notes SET content = " + content + ", date = " + date + "where title = " + title  + "and username = " + username;
        ...
        //sqLiteDatabase.execSQL(updateNote);
    }
}
